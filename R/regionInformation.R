...
#' @docType data
#'
#' @format This region information list is a list six objects: \code{regions}, \code{lines}, \code{out}, \code{centRegion}, \code{centLines}, and
...
#' @keywords datasets
#'
#' @references  The regions in this object have been modified from the following region mask:
#'
